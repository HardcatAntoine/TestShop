package com.assessment.testshop.presentation.screen_cart
...
@Composable
fun ShoppingCartScreen(product: Product) {
    ...
    Column(
        ...
        Button(
            ...
            Row(
                ...
                Box {
                    Text(
                        text = product.price.priceWithDiscount, fontSize = 24.sp, style = TextStyle(
                            Color.White
                        )
                    )
                    Spacer(modifier = Modifier.size(8.dp))
